...
// agrega la cantidad a las acciones en la action con el indice indicado
//void Actions::addAction(int actionIndex, int actionAmount){
//    int index = goodActions->indexOf(actionName);
//    if(index >= 0){
//        // es una accion buena
//        goods[index] += actionAmount;
//    }else{
//        index = sins->indexOf(actionName);
//        // es un pecado y se le suma
//        sinsCommited[index] += actionAmount;
//    }
//}
